                ...
                <div className='course-info'>
                    ...
                    <ul className='bottom-course-sum none-list'>
                        <li>
                            ...
                            <span title="SE1707-NET" className="text-ellipsis" value="SE1707-NET">SE1707-ReactJs</span>
                        </li>
                        <li>
                            <i class="las la-user-circle"></i>
                            <span title="SE1707-NET" className="text-ellipsis" value="SE1707-NET">Beoo</span>
                        </li>
                        <li>
                            <i class="las la-id-card"></i>
                            <span title="SE1707-NET" className="text-ellipsis" value="SE1707-NET">HE1000</span>
                        </li>
                    </ul>
